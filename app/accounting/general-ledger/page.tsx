  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-slate-800 bg-[#111C34] p-8">
        ...
        <h1 className="mt-3 text-4xl font-bold text-white">General Ledger</h1>
        <p className="mt-3 max-w-3xl text-slate-300">Posted account activity, audit trail, debits, credits, and balances.</p>
      </section>
